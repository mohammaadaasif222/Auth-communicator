...
import { useToast } from "@/hooks/use-toast";
import { DatabaseQueryInterface } from "@/components/database-query-interface";
import { User, UserManagementTable } from "@/components/user-management-table";
import { VideoMeeting } from "@/components/video-meeting";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
...
export default function SuperAdminDashboard() {
  ...
  // Fetch companies with proper typing
        ...
        <Tabs defaultValue="users" className="space-y-6">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input 
                                  placeholder="Technology consulting company" 
                                  {...field} 
                                  value={field.value ?? ''} 
                                />
                              </FormControl>
          ...
          <TabsContent value="meetings" className="space-y-6">
            <div className="grid gap-6">
              ...
              {companies.filter((c) => c.zoomMeetingId).length === 0 && (
                <Card>
                  <CardContent className="text-center py-8">
                    <Video className="h-12 w-12 mx-auto text-gray-400 mb-4" />
                    <p className="text-gray-500">No active meetings found</p>
